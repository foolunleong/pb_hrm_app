  ...
  Future<void> _fetchLeaveRequests(DateTime date) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<AdvancedDayEvent<String>> fetchedEvents = [];
          ...
          Padding(
            ...
            child: Row(
              ...
              children: List.generate(7, (index) {
                ...
                final hasEvent = events.any((event) => event.startDateTime.day == day.day && event.startDateTime.month == day.month && event.startDateTime.year == day.year);
