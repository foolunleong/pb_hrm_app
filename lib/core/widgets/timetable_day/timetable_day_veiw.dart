...
class TimeTableDayWidget extends StatelessWidget {
  ...
  final List<Event> eventsTimeTable;
  ...
  Widget build(BuildContext context) {
    ...
    eventsTimeTable.removeWhere((e) => e.startDateTime.hour == 0 || e.endDateTime.hour == 0);
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => EventDetailView(
                    event: {
                      'title': event.title,
                      'description': eventsTimeTable[itemIndex].description,
                      'startDateTime': eventsTimeTable[itemIndex].startDateTime.toString(),
                      'endDateTime': eventsTimeTable[itemIndex].endDateTime.toString(),
