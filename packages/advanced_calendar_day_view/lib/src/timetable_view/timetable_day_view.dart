...
class TimeTableDayView<T extends Object> extends StatefulWidget {
  ...
  @override
  State<TimeTableDayView> createState() => _TimeTableDayViewState<T>();
}

class _TimeTableDayViewState<T extends Object> extends State<TimeTableDayView<T>> {
  ...
  @override
  void didUpdateWidget(covariant TimeTableDayView<T> oldWidget) {
